...
| `CHAOS_KAFKA_BASE_PORT` | `9420` | Kafka gateway listeners (#225): kafka-0 for scenario 16's standalone, kafka-1 for scenario 17's leader, kafka-2 for scenario 18's. |
