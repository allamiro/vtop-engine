...
pub use wire::{
    ...
    AdminReadSegmentPlacementRequest, AdminReadSegmentPlacementResponse,
    AdminReadTopicRangesRequest, AdminReadTopicRangesResponse, AdminRebalanceIntentView,
    AdminSegmentView, AdminStatusRequest, AdminStatusResponse, AdminTopicRangeView,
    AdminTransitionView, PeerAppendRequest, PeerAppendResponse, PeerInstallRequest,
    PeerInstallResponse, PeerVoteRequest, PeerVoteResponse, TransportError, TransportResult,
    VtpmFrame, WireLogId, KIND_ADMIN_ADD_LEARNER_REQ, KIND_ADMIN_CHANGE_MEMBERSHIP_REQ,
    KIND_ADMIN_ERROR, KIND_ADMIN_INIT_REQ, KIND_ADMIN_MEMBERSHIP_RESP, KIND_ADMIN_PROPOSE_REQ,
